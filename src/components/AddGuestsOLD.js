...
import '../components/AddGuestsOLD.css'

const clickOutsideConfig = {
  handleClickOutside: () => AddGuestsOLD.handleClickOutside
};

function AddGuestsOLD(props) {
  ...
  AddGuestsOLD.handleClickOutside = () => {
...
export default onClickOutside(AddGuestsOLD, clickOutsideConfig);
